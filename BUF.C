...
static char *line_cnt proto((Buffer *, char *));
...
/*********************************************/
static void mkbuflist (register  char **bnamp)
/*********************************************/
{
	register  Buffer	*b;
